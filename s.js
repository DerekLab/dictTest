...
if (found_app_scutclient()){
	tabtitle[16].push("", "<#menu5_1_1#>","<#menu5_13_log#>");
} else if (found_app_mentohust()){
	tabtitle[16].push("", "<#menu5_1_1#>","<#menu5_13_log#>");
}
...
if (found_app_aria2()){
	tabtitle[18].push("", "<#menu8_9_1#>");
} else if (found_app_transmission()){
	tabtitle[18].push("", "<#menu8_9_2#>");
}
tabtitle[19] = new Array();
if (found_app_caddy()){
	tabtitle[19].push("", "<#menu8_10_1#>");
}
...
if (found_app_scutclient()){
	...
	tablink[10].push("", "scutclient.asp", "scutclient_log.asp");
}
...
if (found_app_caddy()){
	...
	tablink[18].push("","Advanced_caddy.asp");
}
tablink[19] = new Array();
if (found_app_wyy()){
	wyy_array = new Array("","Advanced_wyy.asp");
	tablink[19].push("","Advanced_wyy.asp");
}
...
if (found_app_aria2()){
	menuL2_title.push("<#menu8_9#>");
} else if (found_app_transmission()){
	menuL2_title.push("<#menu8_9#>");
} else menuL2_title.push("");

if (found_app_caddy()){
	menuL2_title.push("<#menu8_10#>");
} else menuL2_title.push("");
